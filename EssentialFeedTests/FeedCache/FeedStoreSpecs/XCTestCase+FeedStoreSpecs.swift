...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func assertThatRetrieveDeliversFoundValuesOnNonEmptyCache(on sut: FeedStore, file: StaticString = #filePath, line: UInt = #line) {
        ...
        expect(sut: sut, toRetrieve: .success(CachedFeed(feed: feed, timestamp: timestamp)))
    }
    ...
    func assertThatInsertOverridesPreviouslyInsertedCacheValues(on sut: FeedStore) {
        ...
        expect(sut: sut, toRetrieve: .success(CachedFeed(feed: latestFeed, timestamp: latestTimestamp)))
    }
    ...
    func expect(sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrievalResult, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.retrieve { retrievedResult in
            ...
            case (.success(.none), .success(.none)),
                (.failure, .failure):
                break
            case let (.success(.some(expected)), .success(.some(feed: retrieved))):
